      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5">
          ...
          <a
            ...
            target="_blank"
            className="inline-flex items-center justify-center bg-green-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-green-700 transition-all duration-300 shadow-lg gap-3"
          >
            <MessageCircle />
            WhatsApp
          </a>
